/* empty css                      */import{a as g}from"./assets/vendor-BcYoTxAJ.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function i(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=i(s);fetch(s.href,r)}})();const f="https://66b1f8e71ca8ad33d4f5f63e.mockapi.io/campers",d=document.querySelector(".loader");async function k(){try{d.style.display="block";const e=await g.get(f);return d.style.display="none",e.data.items}catch(e){throw console.error("Error:",e),e}}async function C(e){try{d.style.display="block";const t=await g.get(`${f}/${e}`);return d.style.display="none",t.data}catch(t){throw console.error("Error:",t),t}}function v(e){return`<li class="campers-item">
          ...
          </li>`}const h=document.querySelector(".result"),q=document.querySelector(".load-more");function y(e,t){h.innerHTML=e.slice(0,t).map(v).join("");const i=JSON.parse(localStorage.getItem("likedCampers"))||{};document.querySelectorAll(".btn-like").forEach(a=>{const s=a.dataset.id;i[s]&&(a.classList.add("liked"),a.querySelector("img").src="./src/img/red-heart.svg")})}function b(e,t,i){h.insertAdjacentHTML("beforeend",e.slice(t,i).map(v).join(""))}function $(e,t,i){q.style.display=e*t>=i.length?"none":"block"}function E(e){var s,r;const t=((s=document.querySelector("#location"))==null?void 0:s.value.toLowerCase())||"",i=[...document.querySelectorAll(".container-filters.active-filter")].map(c=>c.id),a=((r=document.querySelector('input[name="vehicleType"]:checked'))==null?void 0:r.value)||"";return e.filter(c=>{const L=t?c.location.toLowerCase().includes(t):!0,w=i.every(u=>c[u]===!0||c[u]==="automatic"),S=a?c.form===a:!0;return L&&w&&S})}function M(e){return`
    <section class='camp'>
